...
import static bongwater.doobiedooop.Ikea.utils.PacketUtils.dismountPackets;

public class IKEADupe extends Module {

    public IKEADupe(){
        super(doobiedooopAddon.doobiedooopAddon,"IKEA-dupe-2.0","Does the updated IKEA dupe.");
    }

    private final TimerUtils boatTimer = new TimerUtils();
    private final TimerUtils throwTimer;

    {
        throwTimer = new TimerUtils();
    }
